...
- Learn a 200-D word2vec model for the objects descriptions
...
The binary file for the full word2vec model is available [here](http://www.deepdetect.com/stuff/cdis/cdis.bin.bz2) [Beware, this is a 3G file]

- Add up the vectors for Description, Libelle and Marque features, this yields a 200-D description that fully replaces all text in initial dataset

- Balancing the training examples so that every category is represented somewhere between the mean and the median

The resulting training file is shuffled, and 70K training examples have been removed to be used as a testing set, available here: training file, testing file 

- Train a 1500x750x750 neural net with PReLu activations and dropout (0.5) for ~1M iterations
